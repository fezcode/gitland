...
public static partial class Palette {
    ...
    public static Control Icon(string key, IBrush? color = null, double size = 16) {
        var data = key switch {
            ...
            "trash" => "M4 6L20 6M9 6L9 4L15 4L15 6M6 6L7 21L17 21L18 6M10 10L10 17M14 10L14 17",
            "blame" => "M4 5L20 5M4 10L14 10M4 15L20 15M4 20L14 20M18 18A3 3 0 1 0 18 24A3 3 0 1 0 18 18",
            "history" => "M12 7L12 12L16 14M20 12A8 8 0 1 1 6 6.5M4 3L4 9L10 9",
